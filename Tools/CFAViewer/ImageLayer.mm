...
//    [desc setStorageMode:MTLStorageModeManaged];
    ...
    auto lock = std::lock_guard(_state.lock);
        _state.defringe = Defringe(_device, _heap, _commandQueue);
...
//    [blit endEncoding];
//    
//    [self _renderPass:cmdBuf texture:raw2Txt name:@"CFAViewer::ImageFilter::Defringe::ApplyCorrection"
...
//    {
//        id<MTLCommandBuffer> cmdBuf = [_commandQueue commandBuffer];
//        [self _renderPass:cmdBuf texture:rawTxt name:@"CFAViewer::ImageFilter::Defringe::WhiteBalanceForward"
//            block:^(id<MTLRenderCommandEncoder> encoder) {
//                [encoder setFragmentBytes:&_state.ctx length:sizeof(_state.ctx) atIndex:0];
//                [encoder setFragmentTexture:rawTxt atIndex:0];
//            }
//        ];
//        
//        [self _renderPass:cmdBuf texture:gInterpTxt name:@"CFAViewer::ImageFilter::Defringe::InterpolateG"
//            block:^(id<MTLRenderCommandEncoder> encoder) {
//                [encoder setFragmentBytes:&_state.ctx length:sizeof(_state.ctx) atIndex:0];
//                [encoder setFragmentTexture:rawTxt atIndex:0];
//            }
...
//    {
//        id<MTLCommandBuffer> cmdBuf = [_commandQueue commandBuffer];
//        [self _renderPass:cmdBuf texture:rawTxt name:@"CFAViewer::ImageFilter::Defringe::WhiteBalanceReverse"
//            block:^(id<MTLRenderCommandEncoder> encoder) {
//                [encoder setFragmentBytes:&_state.ctx length:sizeof(_state.ctx) atIndex:0];
