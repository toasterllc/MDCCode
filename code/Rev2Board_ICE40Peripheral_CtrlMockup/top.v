...
module Top(
    ...
    always @(posedge sd_clk_int) begin
        ...
        if (!sd_datOutStateInit || sd_datOutState[14]) begin
            sd_datOutCounter <= 0;
            sd_datOutCounter2 <= 0;
            sd_datOutActive <= 0;
            sd_datOutEnding <= 0;
            ...
            if (sd_sdDatOutFifo_rok) begin
                ...
                sd_datOutState[14] <= 1; // Stay in this state
            end
        end
