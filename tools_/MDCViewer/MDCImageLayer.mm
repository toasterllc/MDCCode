...
- (instancetype)init {
    ...
    MDCAssert(library, return nil);
    
    id<MTLFunction> vertexShader = [library newFunctionWithName:@"MDCImageLayer_VertexShader"];
    MDCAssert(vertexShader, return nil);
    
    id<MTLFunction> fragmentShader = [library newFunctionWithName:@"MDCImageLayer_FragmentShader"];
    MDCAssert(fragmentShader, return nil);
    ...
    MDCAssert(_pipelineState, return nil);
    ...
    auto lock = std::unique_lock(_state.lock);
        ...
        if (len) {
            if (!_state.pixelData || [_state.pixelData length]<len) {
                ...
                MDCAssert(_state.pixelData, return);
            }
