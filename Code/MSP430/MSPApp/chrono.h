// This is a copy of the GCC chrono header, with the time_t portions
// commented-out so it compiles for MSP430.
// (We don't use chrono facilities at runtime, just at compile-time.)
// - Toaster
