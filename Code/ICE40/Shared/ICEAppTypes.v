...
`define Msg_Type_SDSendCmd                                      `Msg_Type_Len'h83
...
`define Msg_Type_SDGetStatus                                    `Msg_Type_Len'h84
...
`define Msg_Type_ImgReset                                       `Msg_Type_Len'h85
`define     Msg_Arg_ImgReset_Val_Bits                           0:0

`define Msg_Type_ImgCapture                                     `Msg_Type_Len'h86
`define     Msg_Arg_ImgCapture_DstBlock_Bits                    2:0 // Wider than currently necessary to future-proof

`define Msg_Type_ImgCaptureStatus                               `Msg_Type_Len'h87
...
`define Msg_Type_ImgReadout                                     `Msg_Type_Len'h88

`define Msg_Type_ImgI2CTransaction                              `Msg_Type_Len'h89
...
`define Msg_Type_ImgI2CStatus                                   `Msg_Type_Len'h8A
