...
`define Msg_Type_ImgReset                                       `Msg_Type_StartBit | `Msg_Type_Len'h05
`define     Msg_Arg_ImgReset_Val_Bits                           0:0

`define Msg_Type_ImgSetHeader                                   `Msg_Type_StartBit | `Msg_Type_Len'h06
`define     Msg_Arg_ImgSetHeader_Header_Bits                    55:8
`define     Msg_Arg_ImgSetHeader_Header_Len                     48
`define     Msg_Arg_ImgSetHeader_Idx_Bits                       7:0
`define     Msg_Arg_ImgSetHeader_Idx_Len                        8

`define Msg_Type_ImgCapture                                     `Msg_Type_StartBit | `Msg_Type_Len'h07
`define     Msg_Arg_ImgCapture_DstBlock_Bits                    2:0 // Wider than currently necessary to future-proof

`define Msg_Type_ImgCaptureStatus                               `Msg_Type_StartBit | `Msg_Type_Resp | `Msg_Type_Len'h08
...
`define Msg_Type_ImgReadout                                     `Msg_Type_StartBit | `Msg_Type_Len'h09
`define     Msg_Arg_ImgReadout_DstBlock_Bits                    2:0 // Wider than currently necessary to future-proof

`define Msg_Type_ImgI2CTransaction                              `Msg_Type_StartBit | `Msg_Type_Len'h0A
...
`define Msg_Type_ImgI2CStatus                                   `Msg_Type_StartBit | `Msg_Type_Resp | `Msg_Type_Len'h0B
...
`define Msg_Type_Readout                                        `Msg_Type_StartBit | `Msg_Type_Len'h0C
