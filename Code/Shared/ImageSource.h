...
#import "Shared/MSP.h"
#import "Shared/ImgSD.h"
#import "Shared/ChecksumFletcher32.h"
#import "Shared/ImagePipeline/ImagePipeline.h"
#import "Shared/ImagePipeline/EstimateIlluminant.h"
#import "Shared/ImagePipeline/RenderThumb.h"
#import "Shared/ELF32Binary.h"
...
//        return 1;
    ...
    void init(const Path& dir) {
        ...
        // Init _dataRead
        {
            _dataRead.thread = std::thread([&] { _dataRead_thread(); });
        }
        
        // Init _thumbRender
        {
            _thumbRender.master.thread = std::thread([&] { _thumbRender_masterThread(); });
    ...
    static void _Join(std::thread& t) {
    ...
    Cleanup dataReadPause() {
        ...
        return std::make_unique<_Cleanup>([=] {
            try {
                ...
                // Ignore if we've been stopped while we paused reading data
            }
        });
    }
